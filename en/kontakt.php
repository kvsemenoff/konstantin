...
<head>
	...
	<title>KW REAL ESTATE - Contact us</title>
				...
				<div class="col-md-6">
					<div class="zk_form_all">
						<ul>
							...
							<li>Weinstrasse 4</li>
							<li>D-80333 Munich</li>
							<li>Germany</li>
							<li class="zk_br">Maria Iskudi</li>
							<li>Assistant to the Management Board</li>
							<li>Phone	+49 (0)89 – 33 99 55 40</li>
							<li>E-mail	mi@konstantin-wettig.com</li>
						</ul>
						
						<div class="zk_form">
							<h3 class="zk_first_li">Contact form</h3>
							<form action="mail.php" name="feedback" method="post" class="zk_form">		
								<input type="text" name="name" id="feedback_name" placeholder="Your Name (required)" /><br/>		
								<input type="text" name="email" id="feedback_email" placeholder="Your Email (required)" /><br/>
								<input type="text" name="phone" placeholder="Your Phone" /><br/>
								<textarea name="message" cols="" rows="5" placeholder="Your Message"></textarea>
								<div id="zk_form"><input type="button" value="Send" onclick="verify_fields();"></div>
								<div class="Error_filling">Failed to send the form! Please check your entries and try again.</div>
							</form>
