...
<div class="az-radar-elems">
	...
	<div class="az-pos4">
		<div class="az-radar-elem-item">Architects</div>
	</div>
	<div class="az-pos5">
		<div class="az-radar-elem-item">Private real estate owners</div>
	</div>
	<div class="az-pos6">
		<div class="az-radar-elem-item">Project developers</div>
	</div>
	<div class="az-pos7">
		<div class="az-radar-elem-item">Communities of heirs</div>
	</div>
	<div class="az-pos8">
		<div class="az-radar-elem-item">Private Investors</div>
	</div>
	<div class="az-pos9">
		<div class="az-radar-elem-item">Law firms </div>
	</div>
	<div class="az-pos10">
		<div class="az-radar-elem-item">Privatization of residential property</div>
	</div>
	<div class="az-pos11">
		<div class="az-radar-elem-item">Mezzanine lenders</div>
	</div>
	<div class="az-pos12">
		<div class="az-radar-elem-item">Property developers</div>
	</div>
	<div class="az-pos13">
		<div class="az-radar-elem-item">Urban planners</div>
	</div>
	<div class="az-pos28">
	...
	<div class="az-pos1">
		<div class="az-radar-elem-item3">Experience</div>
	</div>
	<div class="az-pos2">
		<div class="az-radar-elem-item3">Contacts</div>
	</div>
	<div class="az-radar-elem az-pos14 az-active">
		<div class="az-offerten-lr">
			<div class="az-offerten-tb">
				<div class="az-offerten">Offers</div>
			</div>
		</div>
	</div>
	...
	<div class="az-pos21">
		<div class="az-radar-elem-item2"><strong>Consulting services </strong> urban quarters conceptual design & <br>development</div>
	</div>
	<div class="az-pos22">
		<div class="az-radar-elem-item2"><strong>Potential analyses </strong><br>undeveloped and developed properties</div>
	</div>
	<div class="az-pos23">
		<div class="az-radar-elem-item2"><strong>Discrete realization </strong><br>real estate search requests</div>
	</div>
	<div class="az-pos24">
		<div class="az-radar-elem-item2"><strong>Appraisement services</strong></div>
	</div>
	<div class="az-pos25">
		<div class="az-radar-elem-item2"><strong>Brokerage services </strong><br>mezzanine lenders</div>
	</div>
	<div class="az-pos26">
		<div class="az-radar-elem-item2"><strong>Brokerage services </strong><br>commercial / investment properties</div>
	</div>
	<div class="az-pos27">
		<div class="az-radar-elem-item2"><strong>Real estate scouting services</strong></div>
	</div>
